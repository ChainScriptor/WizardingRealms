  ...
  return (
    <div
      ...
      className={cn(
        ...
        variant === "normal" && "bg-zinc-900/80 backdrop-blur-sm",
        variant === "rainbow" && "bg-zinc-900/80 backdrop-blur-sm",
        !open && "hidden",
        props.className,
      )}
      style={{
        ...
        <button
          ...
          className={cn(
            buttonVariants({
              variant: "ghost",
              className:
                "absolute cursor-pointer end-2 md:end-20 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-200",
              size: "icon",
            }),
          )}
        >
